...
import astrometryGif from '../../assets/astrometry.gif';
      ...
      >
        ...
        >
          <Box
            component="img"
            src={astrometryGif}
            alt="Exoplanet Astrometry Method"
            sx={{
              width: '700px',
              height: 'auto',
              borderRadius: '16px',
        ...
        >
          ...
          >
            Measures the tiny wobble in a star's position caused by the gravitational pull of orbiting planets.
          </Typography>
        </motion.div>
      </Box>
    </Box>
